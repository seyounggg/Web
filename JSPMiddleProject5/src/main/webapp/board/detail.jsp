...
<%
	String no=request.getParameter("no"); //사용자가 보낸 no값
	ReplyBoardVO vo=dao.boardDetailData(Integer.parseInt(no)); //no값을 받아서 detailData에 int로 형변환해서 전달!
	...
	/*
		...
		detail.jsp
			...
			=> 수정 -> update.jsp -> update_ok.jsp -> list.jsp
    ...
    <div class="row">
      <table class="table">
        <tr>
          ...
          <td width="80" class="text-center">${vo.regdate }</td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan=4 class="text-right">
            ...
            <a href="delete.jsp?no=${vo.no }" class="btn btn-xs btn-danger">삭제</a>
