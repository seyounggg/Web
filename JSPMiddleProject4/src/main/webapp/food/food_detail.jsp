...
<%
	...
	/*
		서울특별시 노원구 공릉로 111-1 지번 서울시 노원구 공릉동 633-9
		-----------------------     ----------------------
				addr1						addr2
		temp = 노원구 공릉로 111-1 (=> temp에는 첫번째 공백(" "+1)다음거 부터 잘라와라)
		addr3 = 노원구 (=> 0부터 첫번째 공백까지 잘라와라)
	*/
	
	String address=vo.getAddress();
	String addr1=address.substring(0,address.lastIndexOf("지")); // 지번 앞에서 부터 자름
	String addr2=address.substring(address.lastIndexOf("지")+3); // 공백 포함 지,번을 없애려고 +3을 한거임
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=251836fae5930396e4af8398f239aee1&libraries=services"></script>
</head>
<body>
  <div class="container">
    <div class="row">
      <table class="table">
        <tr>
          <%-- img에 ^ 이걸로 5개 묶어와서 dao에서 자르는 코드를 넣지 않고, 여기서 작성한거임 --%>
