...
public class StudentInsert extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 나머지는 doGet
		/*
		 *  <form method=geet> doGet()호출 -- 잘못써도 doGet으로 호출!!
		...
		out.println("<td width=65%>");
		out.println("<input type=number name=kor size=20 class=input-sm max=100 min=0 step=5 value=50>"); // step은 5단위씩 위아래 화살표로 값 변경 , value에 50을 넣어서 default값을 지정
		out.println("</td>");
		out.println("</tr>");
