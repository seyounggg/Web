...
<body>
  ...
  <table class="table">
    ...
    <tr>
      <th width=20% class="text-center">주요 메소드</th>
      <td width=80%>
        <ul>
          <li>사용자 요청정보
            <ul>
              <li>★★String getParmeter(String key):단일값을 받을 경우에 사용</li>
              <li>String[] getParameterValues(String key):다중값을 받을때 사용</li>
              <li>★★void setCharacterEncoding():디코딩(인고딩 변경)</li>
            </ul>
          </li>
          <li>
            브라우저 정보 / 서버정보
            <ul>
              ...
              <li>★★String getContextPath():사용자 요청 폴더의 루트</li>
            </ul>
          </li>
          <li>
            추가정보
