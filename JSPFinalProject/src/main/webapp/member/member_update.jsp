...
<body>
  <div class="wrapper row3">
    <main class="container clear">
      <h2 class="sectiontitle">회원 정보</h2>
      <div class="row">
      <form method="post" action="../member/member_update_ok.do" name="joinFrm" id="joinFrm">
        <table class="table">
          <tr>
            <th class="text-right" width=10%>아이디</th>
            <td width=90% class="inline">
              <input type=text name=id id=id size=20 class="input-sm" value="${vo.id }" readonly>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td width=90% class="inline">
              <input type=text name=addr1 id=addr1 size=55 class="input-sm" value="${vo.addr1 }" readonly>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan=2 class="text-center">
              <input type=button value="회원수정" class="btn btn-sm btn-success" id="joinBtn">
